...
<div class="page">
    <aside class="sidebar">
        ...
        <nav class="menu">
            ...
            <a href="/admin/ReportsDashboard.php" class="active">Reports</a>
    ...
    <main class="main">
        <div class="header"><h1>Reports Dashboard</h1></div>
        <?php $totalReports = 18; $completedReports = 9; $pendingReports = 6; $overdueReports = 3; ?>
        <div class="stats">
            <div class="card red"><div class="info"><span class="label">Total Reports</span><span class="value"><?php echo $totalReports; ?></span></div></div>
            <div class="card black"><div class="info"><span class="label">Completed</span><span class="value"><?php echo $completedReports; ?></span></div></div>
            <div class="card red"><div class="info"><span class="label">Pending</span><span class="value"><?php echo $pendingReports; ?></span></div></div>
            <div class="card black"><div class="info"><span class="label">Overdue</span><span class="value"><?php echo $overdueReports; ?></span></div></div>
        </div>
        <section class="table-card">
            <h2>Recent Reports</h2>
            <table>
                <thead><tr><th>Report</th><th>Status</th><th>Due Date</th></tr></thead>
                <tbody>
                    <tr><td>Rosario Attendance</td><td>Completed</td><td>Jun 20</td></tr>
                    <tr><td>Maybunga Outreach</td><td>Pending</td><td>Jun 24</td></tr>
                    <tr><td>Kapasigan Finance</td><td>Overdue</td><td>Jun 18</td></tr>
                    <tr><td>Manggahan Meeting</td><td>Completed</td><td>Jun 21</td></tr>
                    <tr><td>Pinagbuhatan Follow-up</td><td>Pending</td><td>Jun 26</td></tr>
                    <tr><td>Biringan Event</td><td>Completed</td><td>Jun 22</td></tr>
                </tbody>
            </table>
        </section>
    </main>
