...
<div class="page">
    ...
    <main class="main">
        ...
        <?php $totalSeekers = 132; $pendingFollowups = 28; $totalLeaders = 39; $totalMembers = 429; ?>
        <div class="stats">
            <div class="card red"><div class="info"><span class="label">Total Seekers</span><span class="value"><?php echo $totalSeekers; ?></span></div></div>
            <div class="card black"><div class="info"><span class="label">Pending Follow-ups</span><span class="value"><?php echo $pendingFollowups; ?></span></div></div>
            ...
            <div class="card black"><div class="info"><span class="label">Leaders Assigned</span><span class="value"><?php echo $totalLeaders; ?></span></div></div>
        </div>
        <section class="table-card">
            <h2>Seeker Status</h2>
            <table>
                <thead><tr><th>Satellite</th><th>New</th><th>Contacted</th></tr></thead>
                <tbody>
                    <tr><td>Rosario</td><td>10</td><td>5</td></tr>
                    <tr><td>Maybunga</td><td>12</td><td>7</td></tr>
                    <tr><td>Kapasigan</td><td>8</td><td>10</td></tr>
                    <tr><td>Manggahan</td><td>11</td><td>9</td></tr>
                    <tr><td>Pinagbuhatan</td><td>9</td><td>6</td></tr>
                    <tr><td>Biringan</td><td>10</td><td>8</td></tr>
                </tbody>
            </table>
        </section>
    </main>
