...
<div class="page">
    <aside class="sidebar">
        ...
        <nav class="menu">
            ...
            <a href="/admin/MembersDashboard.php" class="active">Members</a>
    ...
    <main class="main">
        <div class="header"><h1>Members Dashboard</h1></div>
        <?php $totalMembers = 429; $activeSatellites = 6; $totalLeaders = 39; $openRequests = 98; ?>
        <div class="stats">
            <div class="card red"><div class="info"><span class="label">Total Members</span><span class="value"><?php echo $totalMembers; ?></span></div></div>
            <div class="card black"><div class="info"><span class="label">Total Satellites</span><span class="value"><?php echo $activeSatellites; ?></span></div></div>
            <div class="card red"><div class="info"><span class="label">Total Leaders</span><span class="value"><?php echo $totalLeaders; ?></span></div></div>
            <div class="card black"><div class="info"><span class="label">New Members</span><span class="value">24</span></div></div>
        </div>
        <section class="table-card">
            <h2>Member Breakdown</h2>
            <table>
                <thead><tr><th>Satellite</th><th>Male</th><th>Female</th></tr></thead>
                <tbody>
                    <tr><td>Rosario</td><td>34</td><td>33</td></tr>
                    <tr><td>Maybunga</td><td>38</td><td>38</td></tr>
                    <tr><td>Kapasigan</td><td>34</td><td>33</td></tr>
                    <tr><td>Manggahan</td><td>38</td><td>38</td></tr>
                    <tr><td>Pinagbuhatan</td><td>34</td><td>33</td></tr>
                    <tr><td>Biringan</td><td>38</td><td>38</td></tr>
                </tbody>
            </table>
        </section>
    </main>
