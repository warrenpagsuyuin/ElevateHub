...
<div class="page">
    <aside class="sidebar">
        ...
        <nav class="menu">
            ...
            <a href="/admin/UsersDashboard.php" class="active">Users</a>
    ...
    <main class="main">
        <div class="header"><h1>Users Dashboard</h1></div>
        <?php $totalUsers = 469; $activeMembers = 429; $activeLeaders = 39; $pendingApprovals = 14; ?>
        <div class="stats">
            <div class="card red"><div class="info"><span class="label">Total Users</span><span class="value"><?php echo $totalUsers; ?></span></div></div>
            <div class="card black"><div class="info"><span class="label">Active Members</span><span class="value"><?php echo $activeMembers; ?></span></div></div>
            <div class="card red"><div class="info"><span class="label">Total Leaders</span><span class="value"><?php echo $activeLeaders; ?></span></div></div>
            <div class="card black"><div class="info"><span class="label">Pending Approvals</span><span class="value"><?php echo $pendingApprovals; ?></span></div></div>
        </div>
        <section class="table-card">
            ...
            <table>
                ...
                <tbody>
                    <tr><td>Administrator</td><td>8</td><td>8</td></tr>
                    <tr><td>Leader</td><td>39</td><td>37</td></tr>
                    <tr><td>Staff</td><td>18</td><td>17</td></tr>
                    <tr><td>Volunteer</td><td>24</td><td>22</td></tr>
                    <tr><td>Member</td><td>380</td><td>372</td></tr>
                </tbody>
            </table>
        </section>
    </main>
